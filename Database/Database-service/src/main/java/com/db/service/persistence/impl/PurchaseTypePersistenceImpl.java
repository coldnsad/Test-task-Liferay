...
import com.db.model.impl.PurchaseTypeImpl;
import com.db.model.impl.PurchaseTypeModelImpl;
...
public class PurchaseTypePersistenceImpl
	 ...
	 */
	@Override
	public List<PurchaseType> findByField1(long id) {
	 ...
	 */
	@Override
	public List<PurchaseType> findByField1(long id, int start, int end) {
	 ...
	 */
	@Override
	public List<PurchaseType> findByField1(
	...
	public PurchaseType findByField1_First(
		...
		PurchaseType purchaseType = fetchByField1_First(id, orderByComparator);
	...
	public PurchaseType fetchByField1_First(
		...
		List<PurchaseType> list = findByField1(id, 0, 1, orderByComparator);
	...
	public PurchaseType findByField1_Last(
		...
		PurchaseType purchaseType = fetchByField1_Last(id, orderByComparator);
	...
	public PurchaseType fetchByField1_Last(
		...
		List<PurchaseType> list = findByField1(
