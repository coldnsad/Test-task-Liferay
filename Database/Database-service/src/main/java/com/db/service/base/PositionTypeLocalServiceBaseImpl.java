 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.db.service.impl.PositionTypeLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.db.service.impl.PositionTypeLocalServiceImpl
 * @generated
 */
public abstract class PositionTypeLocalServiceBaseImpl
	...
	public PositionType createPositionType(long id) {
		return positionTypePersistence.create(id);
	}
	...
	public PositionType deletePositionType(long id) throws PortalException {
		return positionTypePersistence.remove(id);
	}
	...
	public PositionType fetchPositionType(long id) {
		return positionTypePersistence.fetchByPrimaryKey(id);
	}
	...
	public PositionType getPositionType(long id) throws PortalException {
		return positionTypePersistence.findByPrimaryKey(id);
	}
