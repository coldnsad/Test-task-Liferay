...
import com.db.exception.NoSuchPositionTypeException;
import com.db.model.PositionType;
import com.db.model.impl.PositionTypeImpl;
import com.db.model.impl.PositionTypeModelImpl;
import com.db.service.persistence.PositionTypePersistence;
import com.db.service.persistence.PositionTypeUtil;
...
public class PositionTypePersistenceImpl
	 ...
	 */
	@Override
	public List<PositionType> findByField1(String name) {
	 ...
	 */
	@Override
	public List<PositionType> findByField1(String name, int start, int end) {
	 ...
	 */
	@Override
	public List<PositionType> findByField1(
	 ...
	 */
	@Override
	public PositionType fetchByField1_First(
		String name, OrderByComparator<PositionType> orderByComparator) {

		List<PositionType> list = findByField1(name, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public PositionType findByField1_Last(
			String name, OrderByComparator<PositionType> orderByComparator)
		throws NoSuchPositionTypeException {

		PositionType positionType = fetchByField1_Last(name, orderByComparator);
	 ...
	 */
	@Override
	public PositionType fetchByField1_Last(
		String name, OrderByComparator<PositionType> orderByComparator) {
		...
		List<PositionType> list = findByField1(
	 ...
	 */
	@Override
	public PositionType[] findByField1_PrevAndNext(
			long id, String name,
			OrderByComparator<PositionType> orderByComparator)
		throws NoSuchPositionTypeException {
	...
	protected PositionType getByField1_PrevAndNext(
