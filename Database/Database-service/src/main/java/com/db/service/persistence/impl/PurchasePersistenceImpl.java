...
import com.db.exception.NoSuchPurchaseException;
import com.db.model.Purchase;
import com.db.model.impl.PurchaseImpl;
import com.db.model.impl.PurchaseModelImpl;
import com.db.service.persistence.PurchasePersistence;
import com.db.service.persistence.PurchaseUtil;
...
public class PurchasePersistenceImpl
	 ...
	 */
	@Override
	public List<Purchase> findByField1(long id) {
	 ...
	 */
	@Override
	public List<Purchase> findByField1(long id, int start, int end) {
	 ...
	 */
	@Override
	public List<Purchase> findByField1(
	 ...
	 */
	@Override
	public Purchase findByField1_First(
			long id, OrderByComparator<Purchase> orderByComparator)
		throws NoSuchPurchaseException {

		Purchase purchase = fetchByField1_First(id, orderByComparator);
	 ...
	 */
	@Override
	public Purchase fetchByField1_First(
		long id, OrderByComparator<Purchase> orderByComparator) {

		List<Purchase> list = findByField1(id, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public Purchase findByField1_Last(
			long id, OrderByComparator<Purchase> orderByComparator)
		throws NoSuchPurchaseException {

		Purchase purchase = fetchByField1_Last(id, orderByComparator);
	 ...
	 */
	@Override
	public Purchase fetchByField1_Last(
		long id, OrderByComparator<Purchase> orderByComparator) {
		...
		List<Purchase> list = findByField1(
	...
	private static final String _FINDER_COLUMN_FIELD1_ID_2 = "purchase.id = ?";
