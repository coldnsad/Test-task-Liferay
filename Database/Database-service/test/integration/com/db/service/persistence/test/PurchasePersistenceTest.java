...
public class PurchasePersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newPurchase.setElectronicId(RandomTestUtil.nextLong());
		...
		Assert.assertEquals(
			existingPurchase.getElectronicId(), newPurchase.getElectronicId());
		Assert.assertEquals(
	...
	public void testCountByField1() throws Exception {
		_persistence.countByField1(RandomTestUtil.nextLong());

		_persistence.countByField1(0L);
	}
	...
	protected OrderByComparator<Purchase> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			"db_Purchase", "id", true, "electronicId", true, "employeeId", true,
			"purchaseDate", true, "purchaseTypeId", true);
	}
	...
	protected Purchase addPurchase() throws Exception {
		...
		purchase.setElectronicId(RandomTestUtil.nextLong());
