 ...
 * <code>com.db.service.impl.PurchaseTypeLocalServiceImpl</code> and
...
public class PurchaseTypeLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.db.service.impl.PurchaseTypeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static PurchaseType createPurchaseType(long id) {
		return getService().createPurchaseType(id);
	}
	 ...
	 */
	public static PurchaseType deletePurchaseType(long id)
		throws PortalException {

		return getService().deletePurchaseType(id);
	}
	...
	public static PurchaseType fetchPurchaseType(long id) {
		return getService().fetchPurchaseType(id);
	}
	 ...
	 * @throws PortalException if a purchase type with the primary key could not be found
	 */
	public static PurchaseType getPurchaseType(long id) throws PortalException {
		return getService().getPurchaseType(id);
	}
