 ...
 * <code>com.db.service.impl.PositionTypeLocalServiceImpl</code> and
...
public class PositionTypeLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.db.service.impl.PositionTypeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static PositionType createPositionType(long id) {
		return getService().createPositionType(id);
	}
	 ...
	 */
	public static PositionType deletePositionType(long id)
		throws PortalException {

		return getService().deletePositionType(id);
	}
	...
	public static PositionType fetchPositionType(long id) {
		return getService().fetchPositionType(id);
	}
	 ...
	 * @throws PortalException if a position type with the primary key could not be found
	 */
	public static PositionType getPositionType(long id) throws PortalException {
		return getService().getPositionType(id);
	}
