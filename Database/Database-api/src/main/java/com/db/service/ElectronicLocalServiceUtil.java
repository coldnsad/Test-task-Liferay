...
/**
 * Provides the local service utility for Electronic. This utility wraps
 * <code>com.db.service.impl.ElectronicLocalServiceImpl</code> and
 ...
 * @generated
 */
public class ElectronicLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.db.service.impl.ElectronicLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Electronic addElectronic(Electronic electronic) {
	 ...
	 */
	public static Electronic createElectronic(long id) {
		return getService().createElectronic(id);
	}
	 ...
	 */
	public static Electronic deleteElectronic(Electronic electronic) {
		return getService().deleteElectronic(electronic);
	}
	 ...
	 */
	public static Electronic deleteElectronic(long id) throws PortalException {
		return getService().deleteElectronic(id);
	}
	...
	public static Electronic fetchElectronic(long id) {
		return getService().fetchElectronic(id);
	}
	 ...
	 * @throws PortalException if a electronic with the primary key could not be found
	 */
	public static Electronic getElectronic(long id) throws PortalException {
		return getService().getElectronic(id);
	}
	 ...
	 */
	public static List<Electronic> getElectronics(int start, int end) {
		return getService().getElectronics(start, end);
	}
	...
	public static int getElectronicsCount() {
		return getService().getElectronicsCount();
	}
	 ...
	 */
	public static Electronic updateElectronic(Electronic electronic) {
		return getService().updateElectronic(electronic);
	}

	public static ElectronicLocalService getService() {
		return _service;
	}

	private static volatile ElectronicLocalService _service;
