...
public class PurchaseTypeUtil {
	 ...
	 */
	public static List<PurchaseType> findByField1(long id) {
	 ...
	 */
	public static List<PurchaseType> findByField1(long id, int start, int end) {
	 ...
	 */
	public static List<PurchaseType> findByField1(
	 ...
	 */
	public static PurchaseType findByField1_First(
			long id, OrderByComparator<PurchaseType> orderByComparator)
		throws com.db.exception.NoSuchPurchaseTypeException {
	 ...
	 */
	public static PurchaseType fetchByField1_First(
		long id, OrderByComparator<PurchaseType> orderByComparator) {
	 ...
	 * @throws NoSuchPurchaseTypeException if a matching purchase type could not be found
	 */
	public static PurchaseType findByField1_Last(
			long id, OrderByComparator<PurchaseType> orderByComparator)
		throws com.db.exception.NoSuchPurchaseTypeException {
	 ...
	 */
	public static PurchaseType fetchByField1_Last(
		long id, OrderByComparator<PurchaseType> orderByComparator) {
