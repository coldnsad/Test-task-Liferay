 ...
 * <code>com.db.service.impl.ElectroEmployeeLocalServiceImpl</code> and
...
public class ElectroEmployeeLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.db.service.impl.ElectroEmployeeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static ElectroEmployee createElectroEmployee(long id) {
		return getService().createElectroEmployee(id);
	}
	 ...
	 */
	public static ElectroEmployee deleteElectroEmployee(long id)
		throws PortalException {

		return getService().deleteElectroEmployee(id);
	}
	...
	public static ElectroEmployee fetchElectroEmployee(long id) {
		return getService().fetchElectroEmployee(id);
	}
	 ...
	 * @throws PortalException if a electro employee with the primary key could not be found
	 */
	public static ElectroEmployee getElectroEmployee(long id)
		throws PortalException {

		return getService().getElectroEmployee(id);
	}
