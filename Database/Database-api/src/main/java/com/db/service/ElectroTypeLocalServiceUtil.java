 ...
 * <code>com.db.service.impl.ElectroTypeLocalServiceImpl</code> and
...
public class ElectroTypeLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.db.service.impl.ElectroTypeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static ElectroType createElectroType(long id) {
		return getService().createElectroType(id);
	}
	 ...
	 */
	public static ElectroType deleteElectroType(long id)
		throws PortalException {

		return getService().deleteElectroType(id);
	}
	...
	public static ElectroType fetchElectroType(long id) {
		return getService().fetchElectroType(id);
	}
	 ...
	 * @throws PortalException if a electro type with the primary key could not be found
	 */
	public static ElectroType getElectroType(long id) throws PortalException {
		return getService().getElectroType(id);
	}
