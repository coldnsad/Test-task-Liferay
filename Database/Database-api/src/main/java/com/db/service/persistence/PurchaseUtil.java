...
public class PurchaseUtil {
	...
	/**
	 * Returns all the purchases where id = &#63;.
	 *
	 * @param id the ID
	 * @return the matching purchases
	 */
	public static List<Purchase> findByField1(long id) {
		return getPersistence().findByField1(id);
	}

	/**
	 * Returns a range of all the purchases where id = &#63;.
	 *
	 * <p>
	 ...
	 */
	public static List<Purchase> findByField1(long id, int start, int end) {
		return getPersistence().findByField1(id, start, end);
	}

	/**
	 * Returns an ordered range of all the purchases where id = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>PurchaseModelImpl</code>.
	 * </p>
	 ...
	 */
	public static List<Purchase> findByField1(
		long id, int start, int end,
		OrderByComparator<Purchase> orderByComparator) {

		return getPersistence().findByField1(id, start, end, orderByComparator);
	}
	...
	/**
	 * Returns the first purchase in the ordered set where id = &#63;.
	 *
	 * @param id the ID
	 ...
	 */
	public static Purchase findByField1_First(
			long id, OrderByComparator<Purchase> orderByComparator)
		throws com.db.exception.NoSuchPurchaseException {

		return getPersistence().findByField1_First(id, orderByComparator);
	}
	 ...
	 */
	public static Purchase fetchByField1_First(
		long id, OrderByComparator<Purchase> orderByComparator) {

		return getPersistence().fetchByField1_First(id, orderByComparator);
	}

	/**
	 * Returns the last purchase in the ordered set where id = &#63;.
	 *
	 * @param id the ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 * @throws NoSuchPurchaseException if a matching purchase could not be found
	 */
	public static Purchase findByField1_Last(
			long id, OrderByComparator<Purchase> orderByComparator)
		throws com.db.exception.NoSuchPurchaseException {

		return getPersistence().findByField1_Last(id, orderByComparator);
	}
	 ...
	 */
	public static Purchase fetchByField1_Last(
		long id, OrderByComparator<Purchase> orderByComparator) {

		return getPersistence().fetchByField1_Last(id, orderByComparator);
	}

	/**
	 * Removes all the purchases where id = &#63; from the database.
	 *
	 * @param id the ID
	 */
	public static void removeByField1(long id) {
		getPersistence().removeByField1(id);
	}

	/**
	 * Returns the number of purchases where id = &#63;.
	 *
	 * @param id the ID
	 * @return the number of matching purchases
	 */
	public static int countByField1(long id) {
		return getPersistence().countByField1(id);
	}
