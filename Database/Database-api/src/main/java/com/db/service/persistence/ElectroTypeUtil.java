...
public class ElectroTypeUtil {
	 ...
	 */
	public static List<ElectroType> findByField1(String name) {
	 ...
	 */
	public static List<ElectroType> findByField1(
	 ...
	 */
	public static ElectroType findByField1_First(
			String name, OrderByComparator<ElectroType> orderByComparator)
		throws com.db.exception.NoSuchElectroTypeException {
	 ...
	 */
	public static ElectroType fetchByField1_First(
		String name, OrderByComparator<ElectroType> orderByComparator) {
	 ...
	 * @throws NoSuchElectroTypeException if a matching electro type could not be found
	 */
	public static ElectroType findByField1_Last(
			String name, OrderByComparator<ElectroType> orderByComparator)
		throws com.db.exception.NoSuchElectroTypeException {
	 ...
	 */
	public static ElectroType fetchByField1_Last(
		String name, OrderByComparator<ElectroType> orderByComparator) {
	 ...
	 */
	public static ElectroType[] findByField1_PrevAndNext(
			long id, String name,
			OrderByComparator<ElectroType> orderByComparator)
		throws com.db.exception.NoSuchElectroTypeException {
