...
public class EmployeeLocalServiceWrapper
	 ...
	 */
	@Override
	public com.db.model.Employee addEmployee(com.db.model.Employee employee) {
	 ...
	 */
	@Override
	public com.db.model.Employee createEmployee(long id) {
	 ...
	 */
	@Override
	public com.db.model.Employee deleteEmployee(
		com.db.model.Employee employee) {
	 ...
	 */
	@Override
	public com.db.model.Employee deleteEmployee(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	@Override
	public com.db.model.Employee fetchEmployee(long id) {
	 ...
	 */
	@Override
	public java.util.List<com.db.model.Employee> getEmployees(
		int start, int end) {
	 ...
	 */
	@Override
	public com.db.model.Employee updateEmployee(
		com.db.model.Employee employee) {
