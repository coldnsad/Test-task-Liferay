...
public interface PurchasePersistence extends BasePersistence<Purchase> {
	 ...
	 */
	public java.util.List<Purchase> findByField1(long id);
	 ...
	 */
	public java.util.List<Purchase> findByField1(long id, int start, int end);
	 ...
	 */
	public java.util.List<Purchase> findByField1(
