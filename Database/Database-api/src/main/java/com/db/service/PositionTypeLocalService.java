...
public interface PositionTypeLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.db.service.impl.PositionTypeLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the position type local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PositionTypeLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public PositionType createPositionType(long id);
	...
	public PositionType deletePositionType(long id) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PositionType fetchPositionType(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PositionType getPositionType(long id) throws PortalException;
